...
.get(async (req, res) => {
    const productsListed = await productData.getProducts(true, 1, 1, {}, {}, {
        _id: 1, productName: 1, productAskingPrice: 1, listingActive: 1, productAskingPrice: 1
    })
...
router.route('/product/:productID/:action')
.get(async (req, res) => {
