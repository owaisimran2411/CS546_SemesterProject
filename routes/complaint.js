...
router
    ...
    .post(async(req, res) =>{
        ...
        try{
            ...
            complaintMessage = primitiveTypeValidation(complaintMessage, 'Complaint Message', 'String');
        }
        catch(e){
            console.log('error', e);
        ...
        try{
            await complaintData.createComplaint(userId, sellerId, complaintMessage);
